...
export function ListValues() {
    return (
        <div className="w-full rounded-lg bg-gray-10 p-2 lg:w-[65%]">
            <div className="md:grid-rows-auto-3 grid grid-cols-1 grid-rows-4 gap-3 divide-y rounded-lg border bg-gray-08 p-6 md:grid-cols-2 md:gap-6 md:divide-y-0 md:p-12">
