...
export function Hero() {
    return (
        <section className="bg-gradient-130 max-w-screen-3xl border-b from-gray-15/70 to-gray-15/0 px-2 py-14 md:py-24 lg:px-4 lg:py-32">
            <div className="mx-auto max-w-screen-2xl space-y-3.5">
